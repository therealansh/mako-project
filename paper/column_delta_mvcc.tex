...
\item \textbf{No Column Split} shows the cost of removing manual vertical partitioning of the STOCK table (merging \texttt{stock} and \texttt{stock\_data} into a single table). Throughput drops by 22--28\% due to larger row sizes on the critical path, demonstrating the importance of the existing column split optimization.
\end{itemize}
