...
\begin{tabular}{ccccc}
\toprule
Threads & \multicolumn{2}{c}{Throughput (Kops/s)} & \multicolumn{2}{c}{Latency (ms)} \\
\cmidrule(lr){2-3} \cmidrule(lr){4-5}
& Baseline & Col-Delta & Baseline & Col-Delta \\
\midrule
1 & 91.1 & 92.6 & 0.0104 & 0.0103 \\
2 & 179.4 & 180.6 & 0.0106 & 0.0105 \\
4 & 347.2 & 347.1 & 0.0110 & 0.0110 \\
6 & 516.1 & 508.3 & 0.0111 & 0.0112 \\
\bottomrule
\end{tabular}
\end{table}
