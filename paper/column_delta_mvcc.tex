...
\midrule
1 & 91.1 & 92.3 & 92.6 & 0.0104 & 0.0103 \\
2 & 179.4 & 170.1 & 180.6 & 0.0106 & 0.0105 \\
4 & 347.2 & 333.3 & 347.1 & 0.0110 & 0.0110 \\
6 & 516.1 & 496.0 & 508.3 & 0.0111 & 0.0112 \\
\bottomrule
\end{tabular}
\end{table}
...
\item \textbf{No Column Split} shows the cost of removing manual vertical partitioning of the Customer table (merging \texttt{customer} and \texttt{customer\_data} into a single table). Throughput impact is minimal (within 5\%) because \texttt{c\_data} is only accessed for ``bad credit'' customers (10\% of Payment transactions).
\end{itemize}
...
\addplot[color=orange,mark=diamond*,thick] coordinates {
    (1, 92.3) (2, 170.1) (4, 333.3) (6, 496.0)
};
